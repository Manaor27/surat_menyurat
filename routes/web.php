...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/surat', [App\Http\Controllers\HomeController::class, 'surat'])->name('surat');
    ...
    Route::put('/suket/update/{id}/{id2}', [SuketController::class, 'update']);
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('/arsipSurat', [AdminController::class, 'arsip']);
